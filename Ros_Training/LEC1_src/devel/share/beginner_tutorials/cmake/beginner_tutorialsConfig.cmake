...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/yangzhe/LEC1_src/src/beginner_tutorial)
  set(beginner_tutorials_DEVEL_PREFIX /home/yangzhe/LEC1_src/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/yangzhe/LEC1_src/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'bbbbigrui <bbbbigrui@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yangzhe/LEC1_src/src/beginner_tutorial/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yangzhe/LEC1_src/devel/lib;/opt/ros/noetic/lib)
