...
message(STATUS "plan_env: 0 messages, 1 services")
...
get_filename_component(_filename "/home/yangzhe/exercise2_stu/src/planner/plan_env/srv/lec4.srv" NAME_WE)
add_custom_target(_plan_env_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "plan_env" "/home/yangzhe/exercise2_stu/src/planner/plan_env/srv/lec4.srv" ""
)
...
### Generating Services
_generate_srv_cpp(plan_env
  "/home/yangzhe/exercise2_stu/src/planner/plan_env/srv/lec4.srv"
  "${MSG_I_FLAGS}"
  ""
