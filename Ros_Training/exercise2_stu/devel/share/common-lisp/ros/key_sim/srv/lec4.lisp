...
(cl:defmethod cl:initialize-instance :after ((m <lec4-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lec4-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name key_sim-srv:<lec4-request> is deprecated: use key_sim-srv:lec4-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <lec4-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader key_sim-srv:x-val is deprecated.  Use key_sim-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <lec4-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader key_sim-srv:y-val is deprecated.  Use key_sim-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <lec4-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader key_sim-srv:z-val is deprecated.  Use key_sim-srv:z instead.")
  (z m))
...
(cl:defmethod cl:initialize-instance :after ((m <lec4-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lec4-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name key_sim-srv:<lec4-response> is deprecated: use key_sim-srv:lec4-response instead.")))

(cl:ensure-generic-function 'is_valid-val :lambda-list '(m))
(cl:defmethod is_valid-val ((m <lec4-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader key_sim-srv:is_valid-val is deprecated.  Use key_sim-srv:is_valid instead.")
  (is_valid m))
